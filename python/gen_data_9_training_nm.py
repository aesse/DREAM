# -*- coding: utf-8 -*-
"""
Created on Thu Dec 22 07:54:32 2016
...
tf = sys.argv[1]
cells = sys.argv[2].split(",") #comma separated list
locFile = sys.argv[3]
motif_size = 25
...
header = "chrm\tstart\tstop\tTF\tCell\tGCWindow\tdhsPeakLabel\tdhsGFootLabel\tdhsGFootCount\tGeneName\tDistance\tlogDistance\tExpressionCluster\tPromoterState\tLocation\tExpression\tlogExpression\tExpression2\tlogExpression2\tOverlaps\tChipStates\tChipLabel\tBoundState\n"
out.write(header)
count = 1
index = 0
for cell in cells:
    ...
    bedFiles = [None, dhsPeaks, dhsGprints, geneLocs, chipSeqLabs]
    bedLabels = ["Motif", "dhsPeak", "dhsGFoot","geneLoc", "chipSeqLabs"]        
